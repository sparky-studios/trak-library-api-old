...
public class ImageController {
     ...
     * and the end-point will return an {@link com.sparky.trak.image.server.exception.ApiError} with exception details.
     *
    ...
    @PostMapping(path = "/games", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
