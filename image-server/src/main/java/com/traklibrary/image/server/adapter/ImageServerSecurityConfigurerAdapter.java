package com.traklibrary.image.server.adapter;

import com.traklibrary.image.server.configuration.JwtConfig;
import com.traklibrary.image.server.filter.JwtAuthorizationFilter;
