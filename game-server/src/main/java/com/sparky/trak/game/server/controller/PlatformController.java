...
@RestController
@RequestMapping(value = "/v1/platforms", produces = MediaTypes.HAL_JSON_VALUE)
public class PlatformController {
     ...
     * the {@link PlatformDto} will not be saved and a {@link com.sparky.trak.game.server.exception.ApiError} will
