...
import com.sparky.trak.game.server.assembler.PublisherRepresentationModelAssembler;
...
@RestController
@RequestMapping(value = "/v1/publishers", produces = MediaTypes.HAL_JSON_VALUE)
public class PublisherController {
     ...
     * the {@link PublisherDto} will not be saved and a {@link com.sparky.trak.game.server.exception.ApiError} will
    ...
    public PagedModel<EntityModel<PublisherDto>> findAll(PublisherSpecification publisherSpecification,
        ...
        // Wrap the page in a HATEOAS response.
        return pagedResourcesAssembler.toModel(new PageImpl<>(publisherDtos, pageable, publisherDtos.size()), publisherRepresentationModelAssembler);
    }
