...
import com.traklibrary.game.server.assembler.GameUserEntryRepresentationModelAssembler;
import com.traklibrary.game.server.exception.ApiError;
import com.traklibrary.game.service.GameUserEntryService;
...
@RestController
@RequestMapping(value = "/entries", produces = "application/vnd.traklibrary.v1.0.hal+json")
