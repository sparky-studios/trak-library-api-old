...
import com.traklibrary.game.server.annotation.AllowedForAdmin;
...
@RestController
@RequestMapping(value = "/", produces = "application/vnd.traklibrary.v1.0.hal+json")
