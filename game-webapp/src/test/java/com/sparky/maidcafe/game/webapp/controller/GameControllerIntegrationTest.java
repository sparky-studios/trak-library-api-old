...
public class GameControllerIntegrationTest {
    ...
    public void beforeAll() {
        IntStream.range(0, 10).forEach(i -> gameSeeder.run());
    ...
    public void save_withInvalidRequestBody_returnsApiError() {
        ...
        ResponseEntity<ApiError> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games", port), HttpMethod.POST, new HttpEntity<>(gameDto, httpHeaders), typeReference);
    ...
    public void findById_withInvalidId_returnsApiErrorAndNotFoundErrorCode() {
        ...
        // Act
        ResponseEntity<ApiError> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.GET, new HttpEntity<>(httpHeaders), typeReference, 1000L);
    ...
    public void findById_withValidId_returnsGameDto() {
        ...
        // Act
        ResponseEntity<EntityModel<GameDto>> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.GET, new HttpEntity<>(httpHeaders), typeReference, 1L);
    ...
    public void update_withInvalidRequestBody_returnsApiError() {
        ...
        // Act
        ResponseEntity<ApiError> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games", port), HttpMethod.PUT, new HttpEntity<>(gameDto, httpHeaders), typeReference);
    ...
    public void patch_withInvalidRequestBody_returnsApiError() {
        ...
        // Act
        ResponseEntity<ApiError> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.PATCH, new HttpEntity<>(jsonMergePatch, httpHeaders), typeReference, 5L);
    ...
    public void patch_withIdNotMappedToGameDto_returnsApiError() {
        ...
        // Act
        ResponseEntity<ApiError> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.PATCH, new HttpEntity<>(jsonMergePatch, httpHeaders), typeReference, 1000L);
    ...
    public void patch_withValidPatchRequestBody_returnsPatchedGameDto() {
        ...
        ResponseEntity<EntityModel<GameDto>> originalGameDto = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.GET, new HttpEntity<>(getHttpHeaders), typeReference, 5L);
        ...
        // Act
        ResponseEntity<EntityModel<GameDto>> responseEntity = testRestTemplate
                .exchange(String.format("http://localhost:%d/api/v1/games/{id}", port), HttpMethod.PATCH, new HttpEntity<>(jsonMergePatch, patchHttpHeaders), typeReference, 5L);
