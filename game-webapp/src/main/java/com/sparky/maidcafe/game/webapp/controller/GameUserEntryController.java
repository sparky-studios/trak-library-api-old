...
import com.sparky.maidcafe.game.webapp.assembler.GameUserEntryRepresentationModelAssembler;
...
public class GameUserEntryController {
     ...
     * the {@link GameUserEntryDto} will not be saved and a {@link com.sparky.maidcafe.game.webapp.exception.ApiError} will
