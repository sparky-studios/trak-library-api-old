...
class TwoFactorAuthenticationSuccessHandlerImplTest {
    ...
    @InjectMocks
    private TwoFactorAuthenticationSuccessHandlerImpl twoFactorAuthenticationSuccessHandler;
    ...
    void onAuthenticationSuccess_withNoRoleAuthority_throwsAuthenticationServiceException() {
        ...
        Assertions.assertThatExceptionOfType(AuthenticationServiceException.class)
                .isThrownBy(() -> twoFactorAuthenticationSuccessHandler.onAuthenticationSuccess(Mockito.mock(HttpServletRequest.class), httpServletResponse, authentication));
    }

    @Test
    void onAuthenticationSuccess_withValidData_generatesAccessTokenAndRefreshToken() throws IOException {
        // Arrange
        ...
        UserData userData = new UserData();
        userData.setAuthorities(Collections.singletonList(new SimpleGrantedAuthority(UserSecurityRole.ROLE_USER.name())));
        ...
        // Act
        twoFactorAuthenticationSuccessHandler.onAuthenticationSuccess(Mockito.mock(HttpServletRequest.class), httpServletResponse, authentication);
